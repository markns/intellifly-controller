...
import (
	...
	samplev1alpha1 "github.com/markns/intellifly-controller/pkg/apis/intelliflycontroller/v1alpha1"
	clientset "github.com/markns/intellifly-controller/pkg/generated/clientset/versioned"
	samplescheme "github.com/markns/intellifly-controller/pkg/generated/clientset/versioned/scheme"
	informers "github.com/markns/intellifly-controller/pkg/generated/informers/externalversions/intelliflycontroller/v1alpha1"
	listers "github.com/markns/intellifly-controller/pkg/generated/listers/intelliflycontroller/v1alpha1"
)
...
func NewController(
	...
	controller := &Controller{
		...
		functionsSynced:   functionInformer.Informer().HasSynced,
...
func (c *Controller) syncHandler(key string) error {
	...
	if err != nil {
		...
		if errors.IsNotFound(err) {
			utilruntime.HandleError(fmt.Errorf("function '%s' in work queue no longer exists", key))
			return nil
		}
	...
	deploymentName := function.Spec.DeploymentName
	if deploymentName == "" {
	...
	if errors.IsNotFound(err) {
		deployment, err = c.kubeclientset.AppsV1().Deployments(function.Namespace).Create(context.TODO(), newDeployment(function), metav1.CreateOptions{})
	}
	...
	if function.Spec.Replicas != nil && *function.Spec.Replicas != *deployment.Spec.Replicas {
		klog.V(4).Infof("Function %s replicas: %d, deployment replicas: %d", name, *function.Spec.Replicas, *deployment.Spec.Replicas)
		deployment, err = c.kubeclientset.AppsV1().Deployments(function.Namespace).Update(context.TODO(), newDeployment(function), metav1.UpdateOptions{})
	}
...
func (c *Controller) updateFunctionStatus(function *samplev1alpha1.Function, deployment *appsv1.Deployment) error {
	...
	_, err := c.sampleclientset.IntelliflyV1alpha1().Functions(function.Namespace).Update(context.TODO(), functionCopy, metav1.UpdateOptions{})
	return err
}
...
func newDeployment(function *samplev1alpha1.Function) *appsv1.Deployment {
	...
	return &appsv1.Deployment{
		ObjectMeta: metav1.ObjectMeta{
			Name:      function.Spec.DeploymentName,
			Namespace: function.Namespace,
			OwnerReferences: []metav1.OwnerReference{
				*metav1.NewControllerRef(function, samplev1alpha1.SchemeGroupVersion.WithKind("Function")),
			},
		},
