...
type FakeFunctions struct {
	Fake *FakeIntelliflyV1alpha1
	ns   string
}

var functionsResource = schema.GroupVersionResource{Group: "intellifly.io", Version: "v1alpha1", Resource: "functions"}

var functionsKind = schema.GroupVersionKind{Group: "intellifly.io", Version: "v1alpha1", Kind: "Function"}
...
func (c *FakeFunctions) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeFunctions) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
