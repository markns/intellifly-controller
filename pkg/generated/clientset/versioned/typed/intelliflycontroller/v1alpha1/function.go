...
import (
	...
	scheme "github.com/markns/intellifly-controller/pkg/generated/clientset/versioned/scheme"
...
func newFunctions(c *IntelliflyV1alpha1Client, namespace string) *functions {
	return &functions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *functions) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
...
func (c *functions) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
