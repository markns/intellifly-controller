	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IntelliflyV1alpha1().Functions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IntelliflyV1alpha1().Functions(namespace).Watch(context.TODO(), options)
			},
		},
		&intelliflycontrollerv1alpha1.Function{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *functionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&intelliflycontrollerv1alpha1.Function{}, f.defaultInformer)
}
